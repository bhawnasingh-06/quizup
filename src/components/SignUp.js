...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      const response = await fetch("http://localhost:5000/api/users/createUsers", {
        method: 'POST',
        headers: {
                      ...
                      <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="text" id="username" name="username" className="form-control" onChange={onchange}/>
